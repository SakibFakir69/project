...
export function getReferer(url) {
    try {
...
export function getCookieFile(url) {
    try {
        const { hostname } = new URL(url);
        const match = Object.keys(COOKIE_FILES).find((host) => hostname.endsWith(host));
...
//# sourceMappingURL=index.contant.js.map